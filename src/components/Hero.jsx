...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const options = {
      strings: ["Frontend Developer.", "MERN-Stack Developer.", "IT'25 Undergrad.","competitive coder."], // Texts to type
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
           ...
           <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
            Hi,I'm <span className="text-gradient bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">Shaik Hussain</span>
</h1>

            <h1 className="text-2xl sm:text-2xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-6">
              <span ref={typedElement} className="text-gradient bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text"></span>
            </h1>
...
<a 
  href="#contact" 
  className="inline-block px-6 py-2 text-base font-semibold text-white bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full hover:opacity-90 transition-all duration-300"
>
  Get in Touch
</a>
